-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_Character
...
function CRB_Character:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_Character.xml")
...
function CRB_Character:OnDocumentReady()
...
function CRB_Character:LoadMilestones(wndUpdate)
...
function CRB_Character:OnInterfaceMenuListHasLoaded()
...
function CRB_Character:OnWindowManagementReady()
...
function CRB_Character:OnToggleCharacterWindow()
...
function CRB_Character:OnToggleReputation()
...
function CRB_Character:OpenReputation()
	self:ShowCharacterWindow()
...
function CRB_Character:OnCharacterMountsCheck(wndHandler, wndControl)
	Event_FireGenericEvent("GenericEvent_InitializeMountsCustomization", self.wndCharacterMounts)
end

function CRB_Character:OnCharacterMountsUncheck(wndHandler, wndControl)
	Event_FireGenericEvent("GenericEvent_DestroyMountsCustomization")
end

function CRB_Character:OnCharacterReputationCheck(wndHandler, wndControl)
	Event_FireGenericEvent("GenericEvent_InitializeReputation", self.wndCharacterReputationList)
end

function CRB_Character:OnCharacterReputationUncheck(wndHandler, wndControl)
...
function CRB_Character:OnNameEditClearTitleBtn()
	CharacterTitle.SetTitle(nil)
	self.strTitle = ""
end

function CRB_Character:ShowCharacterWindow()
...
function CRB_Character:OnCostumeBtnToggle(wndHandler, wndCtrl)
...
function CRB_Character:OnNoCostumeBtn()
	self.wCostumeCheckBtn:SetCheck(false)
	self.wndCostumeSelectionList:Show(false)
	self.nCurrentCostume = nil
...
function CRB_Character:OnOpenCostumes()
	Event_FireGenericEvent("GenericEvent_OpenCostumes")
	self:OnClose()
end

function CRB_Character:OnItemDurabilityUpdate(itemUpdated, nPreviousDurability)
...
function CRB_Character:OnPersonaUpdateCharacterStats()
...
function CRB_Character:OnCostumeSet(idCostume)
...
function CRB_Character:OnClose()
	self.wndCharacter:Show(false)
	Event_FireGenericEvent("CharacterWindowHasBeenClosed")
end

function CRB_Character:OnPrimaryAttributeTabBtn(wndHander, wndControl)
...
function CRB_Character:OnSecondaryAttributeTabBtn(wndHander, wndControl)
	local wndParent = wndControl:GetParent()
	local wndBonusFrame = wndParent:FindChild("BonusFrame")
...
function CRB_Character:OnBonusTabBtn(wndHandler, wndControl)
	local wndParent = wndControl:GetParent()
	local wndBonusFrame = wndParent:FindChild("BonusFrame")
	wndParent:FindChild("MilestoneContainer"):Show(false)
	wndParent:FindChild("SecondaryAttributeFrame"):Show(false)
...
function CRB_Character:DrawAttributes(wndUpdate)
...
function CRB_Character:PrimaryStatsDrawHelper(wndContainer, strName, nValue, strIcon, crTextColor, strTooltip)
...
function CRB_Character:SecondaryStatsDrawHelper(wndContainer, strName, strValue, strIcon, crTextColor, strTooltip)
...
function CRB_Character:UpdateMilestones(wndUpdated)
	-- TODO: REFACTOR
...
function CRB_Character:OnAttributeIconMouseExit(wndHandler, wndControl)
...
function CRB_Character:OnAttributeIconToolip(wndHandler, wndControl, eType, arg1, arg2)
	...
	local wndRankDisplay = wndControl:LoadTooltipForm("CRB_Character.xml", "MilestoneTooltip", self)
...
function CRB_Character:HelperBuildSecondaryTooltips(idx, arProperties)
...
function CRB_Character:OnGenerateTooltip(wndHandler, wndControl, eType, itemCurr, idx)
...
function CRB_Character:OnTutorial_RequestUIAnchor(eAnchor, idTutorial, strPopupText)
	if eAnchor ~= GameLib.CodeEnumTutorialAnchor.CRB_Character then return end
...
function CRB_Character:OnGuildHolomarkToggle(wndHandler, wndControl, eMouseButton)
...
function CRB_Character:OnTitleSelected(wndHandler, wndControl)
...
function CRB_Character:OnPickGuildTag(wndHandler, wndControl) -- GuildTagBtn
...
function CRB_Character:OnCharacterNameEditBtn(wndHandler, wndControl)
	self:OnDrawEditNamePopout()
end

function CRB_Character:OnEffectiveLevelChange()
	self.timerDelayedUpdate = ApolloTimer.Create(0.01, false, "DrawNames", self)
end

function CRB_Character:DrawNames(wndUpdate)
...
function CRB_Character:OnGuildChange()
	self:OnDrawEditNamePopout()
end

function CRB_Character:OnDrawEditNamePopout()
...
function CRB_Character:OnRotateRight(wndHandler, wndControl)
	local wndCostume = wndHandler:GetParent():FindChild("Costume")
	wndCostume:ToggleLeftSpin(true)
end

function CRB_Character:OnRotateRightCancel(wndHandler, wndControl)
	local wndCostume = wndHandler:GetParent():FindChild("Costume")
	wndCostume:ToggleLeftSpin(false)
end

function CRB_Character:OnRotateLeft(wndHandler, wndControl)
	local wndCostume = wndHandler:GetParent():FindChild("Costume")
	wndCostume:ToggleRightSpin(true)
end

function CRB_Character:OnRotateLeftCancel(wndHandler, wndControl)
	local wndCostume = wndHandler:GetParent():FindChild("Costume")
	wndCostume:ToggleRightSpin(false)
end

function CRB_Character:OnSheatheCheck(wndHandler, wndControl)
	local wndCostume = wndHandler:GetParent():FindChild("Costume")
	wndCostume:SetSheathed(wndControl:IsChecked())
end

function CRB_Character:OnLevelUpUnlock_Character_Generic(nExtraData, eValue)
	self:ShowCharacterWindow()
...
function CRB_Character:OnItemConfirmSoulboundOnEquip(eEquipmentSlot, iDDItemEquip, iDDItemDestination)
...
function CRB_Character:OnEquipConfirm()
	self.wndSoulbindConfirm:Show(false)
end

function CRB_Character:OnCancelSoulbindBtn( wndHandler, wndControl, eMouseButton )
	self.wndSoulbindConfirm:Show(false)
end
...
function CRB_Character:OnInspect(unitTarget, arItems)
...
function CRB_Character:OnGenerateInspectTooltip(wndHandler, wndControl)
...
function CRB_Character:OnInspectClose()
...
local CRB_CharacterInstance = CRB_Character:new()
CRB_CharacterInstance:Init()
