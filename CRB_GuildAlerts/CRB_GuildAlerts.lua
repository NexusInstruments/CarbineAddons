-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_GuildAlerts
...
local CRB_GuildAlerts = {}

function CRB_GuildAlerts:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
    return o
...
function CRB_GuildAlerts:Init()
    Apollo.RegisterAddon(self)
end

function CRB_GuildAlerts:OnLoad()
	self.tIntercept = nil
...
-----------------------------------------------------------------------------------------------
-- CRB_GuildAlerts Event Handlers
-----------------------------------------------------------------------------------------------

function CRB_GuildAlerts:OnGuildResultInterceptRequest( eGuildType, wndIntercept, arResultSet )
...
function CRB_GuildAlerts:OnGuildResult(guildSender, strName, nRank, eResult )
...
function CRB_GuildAlerts:OnGuildMessageOfTheDay(guildSender)
	guildSender:GetChannel():Post(guildSender:GetMessageOfTheDay(), Apollo.GetString("GuildInfo_MessageOfTheDay"))
end
-----------------------------------------------------------------------------------------------
-- CRB_GuildAlerts Functions
-----------------------------------------------------------------------------------------------

function CRB_GuildAlerts:IsIntercepted( guildSender, eResult )
...
function CRB_GuildAlerts:GenerateAlert(guildSender, strName, nRank, eResult )
...
-----------------------------------------------------------------------------------------------
-- CRB_GuildAlerts Instance
-----------------------------------------------------------------------------------------------
local CRB_GuildAlertsInst = CRB_GuildAlerts:new()
CRB_GuildAlertsInst:Init()
