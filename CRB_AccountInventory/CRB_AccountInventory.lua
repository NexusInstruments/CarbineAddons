-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_AccountInventory
...
function CRB_AccountInventory:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
...
function CRB_AccountInventory:Init()
    Apollo.RegisterAddon(self)
end

function CRB_AccountInventory:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_AccountInventory.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)
end

function CRB_AccountInventory:OnSave(eType)
...
function CRB_AccountInventory:OnRestore(eType, tSavedData)
	if tSavedData then
...
function CRB_AccountInventory:OnDocumentReady()
...
function CRB_AccountInventory:OnInterfaceMenuListHasLoaded()
...
function CRB_AccountInventory:OnRefreshInterfaceMenuAlert()
...
function CRB_AccountInventory:OnAccountEntitlementUpdate()
...
function CRB_AccountInventory:OnAccountInventoryToggle()
	if not self.tWndRefs.wndMain or not self.tWndRefs.wndMain:IsValid() then
...
function CRB_AccountInventory:OnClose(wndHandler, wndControl)
	if wndHandler == wndControl then
		self:OnDestroy()
	end
end

function CRB_AccountInventory:OnChangeWorld()
	self:OnDestroy()
end

function CRB_AccountInventory:OnDestroy()
...
function CRB_AccountInventory:OnAccountOperationResults(eOperationType, eResult)
...
function CRB_AccountInventory:SetupMainWindow()
	self.tWndRefs.wndMain = Apollo.LoadForm(self.xmlDoc, "CRB_AccountInventoryForm", nil, self)
...
function CRB_AccountInventory:OnInventoryCheck(wndHandler, wndControl, eMouseButton)
	self:OnInventoryUncheck()
	self.tWndRefs.wndInventory:Show(true)
end

function CRB_AccountInventory:OnInventoryUncheck(wndHandler, wndControl, eMouseButton)
...
function CRB_AccountInventory:OnEntitlementsCheck(wndHandler, wndControl, eMouseButton)
	self:OnEntitlementsUncheck()
	self.tWndRefs.wndEntitlements:Show(true)
end

function CRB_AccountInventory:OnEntitlementsUncheck(wndHandler, wndControl, eMouseButton)
...
function CRB_AccountInventory:HelperAddPendingSingleToContainer(wndParent, tPendingAccountItem)
	local strName = ""
	local strIcon = ""
	local strTooltip = ""
...
function CRB_AccountInventory:HelperAddPendingGroupToContainer(wndParent, tPendingAccountItemGroup)
	local wndGroup = Apollo.LoadForm(self.xmlDoc, "InventoryPendingGroupForm", wndParent, self)
...
function CRB_AccountInventory:OnAccountInventory_RefreshInventory()
	Apollo.StopTimer("AccountInventory_RefreshInventory")
	self.bRefreshInventoryThrottle = false
end

function CRB_AccountInventory:RefreshInventory()
...
function CRB_AccountInventory:RefreshInventoryActions()
...
function CRB_AccountInventory:OnPendingInventoryItemCheck(wndHandler, wndControl, eMouseButton)
	self:RefreshInventoryActions()
end

function CRB_AccountInventory:OnPendingInventoryItemUncheck(wndHandler, wndControl, eMouseButton)
	self:RefreshInventoryActions()
end

function CRB_AccountInventory:OnInventoryFilterToggle(wndHandler, wndControl)
...
function CRB_AccountInventory:OnPendingClaimBtn(wndHandler, wndControl, eMouseButton)
...
function CRB_AccountInventory:OnPendingGiftBtn(wndHandler, wndControl, eMouseButton)
...
function CRB_AccountInventory:OnInventoryTakeBtn(wndHandler, wndControl, eMouseButton)
...
function CRB_AccountInventory:OnInventoryRedeemCreddBtn(wndHandler, wndControl, eMouseButton)
...
function CRB_AccountInventory:OnPendingReturnBtn(wndHandler, wndControl, eMouseButton)
...
function CRB_AccountInventory:RefreshPendingConfirm()
...
function CRB_AccountInventory:OnAccountPendingItemsClaimed(wndHandler, wndControl)
	self:RefreshInventory()
	self.tWndRefs.wndInventory:Show(true)
	self.tWndRefs.wndInventoryClaimConfirm:Show(false)
end

function CRB_AccountInventory:OnPendingConfirmCancelBtn(wndHandler, wndControl, eMouseButton)
	self.tWndRefs.wndInventory:Show(true)
	self.tWndRefs.wndInventoryClaimConfirm:Show(false)
end
...
function CRB_AccountInventory:OnAccountPendingItemTook(wndHandler, wndControl)
	self:RefreshInventory()
	self.tWndRefs.wndInventory:Show(true)
	self.tWndRefs.wndInventoryTakeConfirm:Show(false)
end

function CRB_AccountInventory:OnInventoryTakeConfirmCancelBtn(wndHandler, wndControl, eMouseButton)
	self.tWndRefs.wndInventory:Show(true)
	self.tWndRefs.wndInventoryTakeConfirm:Show(false)
end
...
function CRB_AccountInventory:OnAccountCREDDRedeemed(wndHandler, wndControl)
	self:RefreshInventory()
	self.tWndRefs.wndInventory:Show(true)
	self.tWndRefs.wndInventoryRedeemCreddConfirm:Show(false)
end

function CRB_AccountInventory:OnInventoryCreddRedeemConfirmCancelBtn(wndHandler, wndControl, eMouseButton)
	self.tWndRefs.wndInventory:Show(true)
	self.tWndRefs.wndInventoryRedeemCreddConfirm:Show(false)
end
...
function CRB_AccountInventory:OnFriendshipRemove()
...
function CRB_AccountInventory:RefreshInventoryGift()
...
function CRB_AccountInventory:RefreshInventoryGiftActions()
...
function CRB_AccountInventory:OnFriendCheck(wndHandler, wndControl, eMouseButton)
	self:RefreshInventoryGiftActions()
end

function CRB_AccountInventory:OnFriendUncheck(wndHandler, wndControl, eMouseButton)
	self:RefreshInventoryGiftActions()
end

function CRB_AccountInventory:OnPendingSelectFriendGiftBtn(wndHandler, wndControl, eMouseButton)
	local tSelectedPendingData = self.tWndRefs.wndInventoryGift:GetData()
...
function CRB_AccountInventory:OnPendingGiftCancelBtn(wndHandler, wndControl, eMouseButton)
	self.tWndRefs.wndInventory:Show(true)
	self.tWndRefs.wndInventoryGift:Show(false)
end

function CRB_AccountInventory:RefreshEntitlements()
...
function CRB_AccountInventory:RefreshInventoryGiftConfirm()
...
function CRB_AccountInventory:OnAccountPendingItemsGifted(wndHandler, wndControl)
	self:RefreshInventory()
	self.tWndRefs.wndInventory:Show(true)
	self.tWndRefs.wndInventoryGiftConfirm:Show(false)
end

function CRB_AccountInventory:OnPendingGiftConfirmCancelBtn(wndHandler, wndControl, eMouseButton)
	self.tWndRefs.wndInventoryGift:Show(true)
	self.tWndRefs.wndInventoryGiftConfirm:Show(false)
end
...
function CRB_AccountInventory:RefreshInventoryGiftReturnConfirm()
...
function CRB_AccountInventory:OnAccountPendingItemsReturned(wndHandler, wndControl)
	self:RefreshInventory()
	self.tWndRefs.wndInventory:Show(true)
	self.tWndRefs.wndInventoryGiftReturnConfirm:Show(false)
end

function CRB_AccountInventory:OnPendingGiftReturnConfirmCancelBtn(wndHandler, wndControl, eMouseButton)
	self.tWndRefs.wndInventory:Show(true)
	self.tWndRefs.wndInventoryGiftReturnConfirm:Show(false)
end
...
function CRB_AccountInventory:HelperCooldown(nRawTime)
...
local CRB_AccountInventoryInst = CRB_AccountInventory:new()
CRB_AccountInventoryInst:Init()
