-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_CharacterCustomization
...
-----------------------------------------------------------------------------------------------
-- CRB_CharacterCustomization Module Definition
-----------------------------------------------------------------------------------------------
local CRB_CharacterCustomization = {} 
...
-- Initialization
-----------------------------------------------------------------------------------------------
function CRB_CharacterCustomization:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self 
...
function CRB_CharacterCustomization:Init()
	local tDependencies = {}
...
-----------------------------------------------------------------------------------------------
-- CRB_CharacterCustomization OnLoad
-----------------------------------------------------------------------------------------------
function CRB_CharacterCustomization:OnLoad()
    -- load our form file
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_CharacterCustomization.xml")
	self.xmlDoc:RegisterCallback("OnDocLoaded", self)
end

-----------------------------------------------------------------------------------------------
-- CRB_CharacterCustomization OnDocLoaded
-----------------------------------------------------------------------------------------------
function CRB_CharacterCustomization:OnDocLoaded()
...
--Init
function CRB_CharacterCustomization:OnInit()
	if not GameLib.IsCharacterLoaded() or self.wndMain then
		return
	end

	self.wndMain = Apollo.LoadForm(self.xmlDoc, "CRB_CharacterCustomization", nil, self)
...
function CRB_CharacterCustomization:GetCharacterInfo()
	self.arCharacterBones = self.wndPreview:GetBones()
	self.arCurrentCustomizationOptions = self.wndPreview:GetLooks()
end

function CRB_CharacterCustomization:LoadCustomizationHeaders()
...
function CRB_CharacterCustomization:LoadHeader(idSlider, tCategory)
...
function CRB_CharacterCustomization:LoadCustomizationOptions(wndCategoryHeader, tCategory)
...
function CRB_CharacterCustomization:OnCategoryCheck(wndHandler, wndControl)
...
function CRB_CharacterCustomization:OnCategoryUncheck(wndHandler, wndControl)
...
function CRB_CharacterCustomization:OnOptionCheck(wndHandler, wndControl)
...
function CRB_CharacterCustomization:OnOptionUndo(wndHandler, wndControl)
...
function CRB_CharacterCustomization:LoadBoneCustomizationOption(wndCategoryHeader, strOptionWindow, tBone)
	local wndContainer = wndCategoryHeader:FindChild("GroupContents")
...
function CRB_CharacterCustomization:OnBoneCategoryCheck(wndHandler, wndControl)
...
function CRB_CharacterCustomization:OnBoneChanged(wndHandler, wndControl)
...
function CRB_CharacterCustomization:SetBoneCostPreview()
...
function CRB_CharacterCustomization:OnUndoBone(wndHandler, wndControl)
...
function CRB_CharacterCustomization:ResetBone(idSlider)
...
function CRB_CharacterCustomization:OnCostPreview(wndHandler, wndControl)
...
function CRB_CharacterCustomization:ResizePreview()
	local wndCostPreview = self.wndMain:FindChild("PreviewChangesFlyout")
...
function CRB_CharacterCustomization:OnBuyBtn(wndHandler, wndControl)
...
function CRB_CharacterCustomization:OnPurchaseConfirm(wndHandler, wndControl)
...
function CRB_CharacterCustomization:OnPurchaseCancel(wndHandler, wndControl)
	self:ToggleOverlay(ktOverlayTypes.Purchase, false)
end

function CRB_CharacterCustomization:OnUseTokenToggle(wndHandler, wndControl)
...
-- Close Confirmation
-----------------------------------------------------------------------------------------------
function CRB_CharacterCustomization:OnClose()
	self.arCharacterBones = {}
	self.arCurrentCustomizationOptions = {}
...
function CRB_CharacterCustomization:OnCancel(wndHandler, wndControl)
...
function CRB_CharacterCustomization:OnCloseConfirm(wndHandler, wndControl)
	self:ToggleOverlay(ktOverlayTypes.Cancel, false)
	self:OnClose()
end

function CRB_CharacterCustomization:OnCloseCancel(wndHandler, wndControl)
	self:ToggleOverlay(ktOverlayTypes.Cancel, false)
end
...
-----------------------------------------------------------------------------------------------
function CRB_CharacterCustomization:OnRotateRight()
	self.wndPreview:ToggleLeftSpin(true)
end

function CRB_CharacterCustomization:OnRotateRightCancel()
	self.wndPreview:ToggleLeftSpin(false)
end

function CRB_CharacterCustomization:OnRotateLeft()
	self.wndPreview:ToggleRightSpin(true)
end

function CRB_CharacterCustomization:OnRotateLeftCancel()
	self.wndPreview:ToggleRightSpin(false)
end

function CRB_CharacterCustomization:OnSheatheCheck(wndHandler, wndControl)
...
function CRB_CharacterCustomization:OnSaveLoadBtn( wndHandler, wndControl)
...
function CRB_CharacterCustomization:OnLoadCode(wndHandler, wndControl)
	local wndSaveLoadForm = self.wndMain:FindChild("ConfirmationOverlay:CharacterCode")
...
function CRB_CharacterCustomization:OnCancelLoad(wndHandler, wndControl)
	self:ToggleOverlay(ktOverlayTypes.Code, false)
end
...
function CRB_CharacterCustomization:ToggleOverlay(eConfirmationType, bShow)
...
function CRB_CharacterCustomization:CalculateTotalCost()
...
function CRB_CharacterCustomization:ResizeTree()
...
function CRB_CharacterCustomization:CheckForBoneChanges()
...
function CRB_CharacterCustomization:CheckForTokens()
	if self.wndMain and self.wndMain:IsValid() then
		local unitPlayer = GameLib.GetPlayerUnit()
...
function CRB_CharacterCustomization:ReloadOpenCategory()
...
function CRB_CharacterCustomization:OnGenerateIconTooltip(wndHandler, wndControl)
	Tooltip.GetItemTooltipForm(self, wndControl, Item.GetDataFromId(knTokenItemId), {})
end

function CRB_CharacterCustomization:UndoAll()
...
function CRB_CharacterCustomization:ResetTabs()
	if self.idSelectedCategory and self.tOptionWindows[self.idSelectedCategory] then
		local wndHeaderBtn = self.tOptionWindows[self.idSelectedCategory].wndHeader:FindChild("CategorySelectBtn")
		wndHeaderBtn:SetCheck(false)
		self:OnCategoryUncheck(wndHeaderBtn, wndHeaderBtn)
...
function CRB_CharacterCustomization:OnHideHelm()
	self.bHideHelm = true
	self:ReloadOpenCategory()
	self.wndPreview:RemoveItem(GameLib.CodeEnumItemSlots.Head)
end

function CRB_CharacterCustomization:OnRestoreHelm()
	self.bHideHelm = false
	self:ReloadOpenCategory()
	self.wndPreview:SetItem(self.itemDisplayedHelm)
end

function CRB_CharacterCustomization:OnReloadPreviewWindow()
	for idx, tOption in pairs(self.arCurrentCustomizationOptions) do
...
-----------------------------------------------------------------------------------------------
-- CRB_CharacterCustomization Instance
-----------------------------------------------------------------------------------------------
local CRB_CharacterCustomizationInst = CRB_CharacterCustomization:new()
