-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_RaidFrameLeaderOptions
-- Copyright (c) NCsoft. All rights reserved
-----------------------------------------------------------------------------------------------

require "Window"

local CRB_RaidFrameLeaderOptions = {}
...
function CRB_RaidFrameLeaderOptions:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
    return o
...
function CRB_RaidFrameLeaderOptions:Init()
    Apollo.RegisterAddon(self)
end

function CRB_RaidFrameLeaderOptions:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_RaidFrameLeaderOptions.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)
end

function CRB_RaidFrameLeaderOptions:OnDocumentReady()
...
function CRB_RaidFrameLeaderOptions:Initialize(bShow)
	...
	self.wndMain = Apollo.LoadForm(self.xmlDoc, "CRB_RaidFrameLeaderOptionsForm", nil, self)
...
function CRB_RaidFrameLeaderOptions:BuildList()
...
function CRB_RaidFrameLeaderOptions:OnConfigSetAsDPSCheck(wndHandler, wndControl)
	if wndHandler == wndControl then
		GroupLib.SetRoleDPS(wndHandler:GetData(), true) -- Will fire event Group_MemberFlagsChanged
	end
end

function CRB_RaidFrameLeaderOptions:OnConfigSetAsDPSUncheck(wndHandler, wndControl)
	if wndHandler == wndControl then
		GroupLib.SetRoleDPS(wndHandler:GetData(), false) -- Will fire event Group_MemberFlagsChanged
	end
end

function CRB_RaidFrameLeaderOptions:OnConfigSetAsHealCheck(wndHandler, wndControl)
	if wndHandler == wndControl then
		GroupLib.SetRoleHealer(wndHandler:GetData(), true) -- Will fire event Group_MemberFlagsChanged
	end
end

function CRB_RaidFrameLeaderOptions:OnConfigSetAsHealUncheck(wndHandler, wndControl)
	if wndHandler == wndControl then
		GroupLib.SetRoleHealer(wndHandler:GetData(), false) -- Will fire event Group_MemberFlagsChanged
	end
end

function CRB_RaidFrameLeaderOptions:OnConfigSetAsTankCheck(wndHandler, wndControl) -- SetTankBtn
	if wndHandler == wndControl then
		GroupLib.SetRoleTank(wndHandler:GetData(), true) -- Will fire event Group_MemberFlagsChanged
	end
end

function CRB_RaidFrameLeaderOptions:OnConfigSetAsTankUncheck(wndHandler, wndControl) -- SetTankBtn
	if wndHandler == wndControl then
		GroupLib.SetRoleTank(wndHandler:GetData(), false) -- Will fire event Group_MemberFlagsChanged
	end
end

function CRB_RaidFrameLeaderOptions:OnConfigSetAsMainTankCheck(wndHandler, wndControl)
	GroupLib.SetMainTank(wndHandler:GetData(), true) -- Will fire event Group_MemberFlagsChanged
end

function CRB_RaidFrameLeaderOptions:OnConfigSetAsMainTankUncheck(wndHandler, wndControl)
	GroupLib.SetMainTank(wndHandler:GetData(), false) -- Will fire event Group_MemberFlagsChanged
end

function CRB_RaidFrameLeaderOptions:OnConfigSetAsRaidAssistCheck(wndHandler, wndControl)
	GroupLib.SetRaidAssistant(wndHandler:GetData(), true) -- Will fire event Group_MemberFlagsChanged
end

function CRB_RaidFrameLeaderOptions:OnConfigSetAsRaidAssistUncheck(wndHandler, wndControl)
	GroupLib.SetRaidAssistant(wndHandler:GetData(), false) -- Will fire event Group_MemberFlagsChanged
end

function CRB_RaidFrameLeaderOptions:OnConfigSetAsMainAssistCheck(wndHandler, wndControl)
	GroupLib.SetMainAssist(wndHandler:GetData(), true) -- Will fire event Group_MemberFlagsChanged
end

function CRB_RaidFrameLeaderOptions:OnConfigSetAsMainAssistUncheck(wndHandler, wndControl)
	GroupLib.SetMainAssist(wndHandler:GetData(), false) -- Will fire event Group_MemberFlagsChanged
end

function CRB_RaidFrameLeaderOptions:OnKickBtn(wndHandler, wndControl)
	GroupLib.Kick(wndHandler:GetData(), "")
end

function CRB_RaidFrameLeaderOptions:OnLockAllRolesCheck(wndHandler, wndControl)
	for nIdx = 1, GroupLib.GetMemberCount() do
		GroupLib.SetRoleLocked(nIdx, true)
	end
end

function CRB_RaidFrameLeaderOptions:OnLockAllRolesUncheck(wndHandler, wndControl)
	for nIdx = 1, GroupLib.GetMemberCount() do
...
function CRB_RaidFrameLeaderOptions:OnSetRaidLeaderConfirmBtn(wndHandler, wndControl)
...
function CRB_RaidFrameLeaderOptions:OnOptionsCloseBtn() -- Also OnSetRaidLeaderConfirmBtn
	if self.wndMain and self.wndMain:IsValid() then
		self.wndMain:Destroy()
		self.wndMain = nil
...
function CRB_RaidFrameLeaderOptions:OnDestroyAndRedrawAll() -- Group_MemberFlagsChanged
	if self.wndMain and self.wndMain:IsValid() then
...
function CRB_RaidFrameLeaderOptions:FactoryProduce(wndParent, strFormName, tObject)
...
local CRB_RaidFrameLeaderOptionsInst = CRB_RaidFrameLeaderOptions:new()
CRB_RaidFrameLeaderOptionsInst:Init()
