...
---------------------------------------------------------------------------------------------------
-- CRB_ErrorDialog module definition
---------------------------------------------------------------------------------------------------
local CRB_ErrorDialog = {}
...
---------------------------------------------------------------------------------------------------
-- CRB_ErrorDialog initialization
---------------------------------------------------------------------------------------------------
function CRB_ErrorDialog:new(o)
	o = o or {}
	setmetatable(o, self)
	self.__index = self
...
---------------------------------------------------------------------------------------------------
function CRB_ErrorDialog:Init()
	Apollo.RegisterAddon(self)
end

function CRB_ErrorDialog:OnSave(eType)
...
function CRB_ErrorDialog:OnRestore(eType, tSavedData)
...
---------------------------------------------------------------------------------------------------
-- CRB_ErrorDialog EventHandlers
---------------------------------------------------------------------------------------------------
function CRB_ErrorDialog:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_ErrorDialog.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self) 
end

function CRB_ErrorDialog:OnDocumentReady()
...
function CRB_ErrorDialog:OnWindowMove()
...
function CRB_ErrorDialog:FillSubcategories()
	local wndCatList = self.wndReportBug:FindChild("Category")
...
function CRB_ErrorDialog:OnGameClickUnit(unitClicked)
...
function CRB_ErrorDialog:OnGameClickWorld(tPos)
...
function CRB_ErrorDialog:OnGameClickProp(idProp)
	local strPropId = tostring(idProp)
	self.wndReportBug:FindChild("PropId"):SetText(strPropId)
end

function CRB_ErrorDialog:ShowErrorDialog(bShow)
	--[[
...
function CRB_ErrorDialog:OnCancelBtn()
	self.wndReportBug:Show(false)
end

function CRB_ErrorDialog:OnBugOpen(strText)
...
function CRB_ErrorDialog:ToggleWindow()
...
function CRB_ErrorDialog:OnLuaError(tAddon, strError, bCanIgnore)
...
function CRB_ErrorDialog:OnSuspendAddon(wndHandler, wndControl)
...
function CRB_ErrorDialog:OnDisableAddon(wndHandler, wndControl, eMouseButton)
	local tAddon = self.wndErrorDialog:GetData()
	Apollo.SuspendAddon(tAddon.strName)
...
function CRB_ErrorDialog:OnIgnoreError(wndHandler, wndControl)
	self.wndErrorDialog:Destroy()
	self.wndErrorDialog = nil
end

function CRB_ErrorDialog:OnCloseBtn(wndHandler, wndControl)
	self.wndErrorDialog:Destroy()
	self.wndErrorDialog = nil
end

function CRB_ErrorDialog:OnCloseErrorWindow(wndHandler, wndControl)
	wndHandler:Destroy()
end
...
function CRB_ErrorDialog:OnReportBug( wndHandler, wndControl, eMouseButton )
	local wndSubcatList = self.wndReportBug:FindChild("SubCategory")
...
function CRB_ErrorDialog:OnCategoryChanged()
	Sound.Play(Sound.PlayUIButtonHoloSmall)
	self:FillSubcategories()
end

function CRB_ErrorDialog:OnSubcategoryChanged()
	Sound.Play(Sound.PlayUIButtonHoloSmall)
	local wndCatList = self.wndReportBug:FindChild("Category")
	local wndSubcatList = self.wndReportBug:FindChild("SubCategory")
...
function CRB_ErrorDialog:OnInsertPosition(wndHandler, wndControl, eMouseButton)
...
function CRB_ErrorDialog:OnInsertPropId(wndHandler, wndControl, eMouseButton)
...
function CRB_ErrorDialog:OnQuestChanged(wndHandler, wndControl)
	Sound.Play(Sound.PlayUIButtonHoloSmall)
	local wndList = self.wndReportBug:FindChild("QuestList")
...
function CRB_ErrorDialog:OnClearUnit( wndHandler, wndControl, eMouseButton )
	self.unitSelected = nil
	self.wndReportBug:FindChild("Unit"):SetText("")
end

function CRB_ErrorDialog:OnDescriptionChanged(wndHandler, wndControl, strText)
...
function CRB_ErrorDialog:OnQuestListToggle(wndHandler, wndControl)
...
---------------------------------------------------------------------------------------------------
-- CRB_ErrorDialog instance
---------------------------------------------------------------------------------------------------
local CRB_ErrorDialogInst = CRB_ErrorDialog:new()
CRB_ErrorDialogInst:Init()
