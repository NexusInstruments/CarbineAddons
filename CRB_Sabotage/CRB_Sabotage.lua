-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_Sabotage
...
function CRB_Sabotage:Init()
	Apollo.RegisterAddon(self)
end

function CRB_Sabotage:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_Sabotage.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)
	
	self.tBombCarriers = { }
end

function CRB_Sabotage:OnSave(eType)
...
function CRB_Sabotage:OnRestore(eType, tSavedData)
...
function CRB_Sabotage:OnDocumentReady()
...
function CRB_Sabotage:OnChangeWorld()
	self.wndMain:Show(false)
	Apollo.StopTimer("Sabotage_OneSecMatchTimer")
	self.peMatch = nil
...
function CRB_Sabotage:OnWarPlotOneSecMatchTimer()
...
function CRB_Sabotage:OnSabotageBombCarrier(nTimeInMs, unitCarrier, idTeam)
...
function CRB_Sabotage:OnSabotageBombDropped(idCarrier)
...
function CRB_Sabotage:DrawHealth(peoHealth, wndBar, wndProgress)
...
function CRB_Sabotage:DrawBomb(wndBomb)
	if not wndBomb then
		return
	end
...
function CRB_Sabotage:DrawControlPoint(peoControlPoint, wndPoint, nIndex)
	wndPoint:SetMax(100)
...
function CRB_Sabotage:CheckForSabotage()
...
local CRB_SabotageInstance = CRB_Sabotage:new()
