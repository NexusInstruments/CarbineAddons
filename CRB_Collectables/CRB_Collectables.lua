-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_Collectables
...
-----------------------------------------------------------------------------------------------
-- CRB_Collectables Module Definition
-----------------------------------------------------------------------------------------------
local CRB_Collectables = {} 
 
-----------------------------------------------------------------------------------------------
-- Initialization
-----------------------------------------------------------------------------------------------
function CRB_Collectables:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self 
...
function CRB_Collectables:Init()
...
-----------------------------------------------------------------------------------------------
-- CRB_Collectables OnLoad
-----------------------------------------------------------------------------------------------
function CRB_Collectables:OnLoad()
    -- load our form file
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_Collectables.xml")
	self.xmlDoc:RegisterCallback("OnDocLoaded", self)
end

-----------------------------------------------------------------------------------------------
-- CRB_Collectables OnDocLoaded
-----------------------------------------------------------------------------------------------
function CRB_Collectables:OnDocLoaded()
	...
	Apollo.RegisterEventHandler("GenericEvent_OpenCollectables", "OnCRB_CollectablesOn", self)
...
function CRB_Collectables:OnRequestReady()
	Event_FireGenericEvent("GenericEvent_CollectablesReady", self.wndMain:FindChild("HoloBG"))
end
...
function CRB_Collectables:RegisterAddon(nTabOrder, strEventBase, strTabLabel)
...
function CRB_Collectables:DrawTabs()
...
function CRB_Collectables:OnOpenTab(strEvent)
	if strEvent and tostring(strEvent) then
		...
		self:OnCRB_CollectablesOn()
	end
end

function CRB_Collectables:OnCRB_CollectablesOn()
...
function CRB_Collectables:OnTabCheck(wndHandler, wndControl)
...
function CRB_Collectables:OnClose(wndHandler, wndControl)
	self.wndMain:Show(false, true)
...
-----------------------------------------------------------------------------------------------
-- CRB_Collectables Instance
-----------------------------------------------------------------------------------------------
local CRB_CollectablesInst = CRB_Collectables:new()
CRB_CollectablesInst:Init()
