-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_GalacticArchive
...
function CRB_GalacticArchive:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
...
function CRB_GalacticArchive:Init()
    Apollo.RegisterAddon(self)
end

function CRB_GalacticArchive:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_GalacticArchive.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self) 
end

function CRB_GalacticArchive:OnDocumentReady()
...
function CRB_GalacticArchive:Initialize(wndParent, wndMostTopLevel)
...
function CRB_GalacticArchive:OnGenericEvent_ShowGalacticArchive(artData)
	if artData:GetCategories() ~= nil then
		self:DisplayArticle(artData)
	end
end

function CRB_GalacticArchive:OnToggleGalacticArchiveWindow(wndParent, wndMostTopLevel)
...
function CRB_GalacticArchive:OnFilterShowAllSelect(wndHandler, wndControl)
...
function CRB_GalacticArchive:OnFilterTypeSelect(wndHandler, wndControl)
...
function CRB_GalacticArchive:OnFilterTypeUnselect(wndHandler, wndControl)
	for idx, wndCurr in ipairs(self.tWndTopFilters) do
...
function CRB_GalacticArchive:OnNameFilterChanged()
	self:FilterArchiveIndex()
end

function CRB_GalacticArchive:OnHeaderBtnItemClick(wndHandler, wndControl)
...
-----------------------------------------------------------------------------------------------
function CRB_GalacticArchive:HelperShouldShowArticle(artCurr)
...
function CRB_GalacticArchive:OnHeaderBtnMouseEnter(wndHandler, wndControl)
	wndHandler:FindChild("HeaderBtnText"):SetTextColor(ApolloColor.new("UI_TextHoloTitle"))
end

function CRB_GalacticArchive:OnHeaderBtnMouseExit(wndHandler, wndControl)
	wndHandler:FindChild("HeaderBtnText"):SetTextColor(ApolloColor.new("UI_TextHoloTitle"))
end

function CRB_GalacticArchive:OnEmptyLabelBtn(wndHandler, wndControl)
...
function CRB_GalacticArchive:PopulateArchiveIndex()
	if not self.wndArchiveIndexForm or not self.wndArchiveIndexForm:IsValid() then
		return
	end
...
function CRB_GalacticArchive:OnPopulateArchiveIndexTimer()
...
function CRB_GalacticArchive:FilterArchiveIndex()
	local nNumOfNewArticles = 0
...
function CRB_GalacticArchive:FormatHeaderDisplay(wndHeader)
...
function CRB_GalacticArchive:BuildAHeader(artBuilding)
...
-- Add Article
-----------------------------------------------------------------------------------------------
function CRB_GalacticArchive:AddArticleToIndex(artData, wndParent)
...
function CRB_GalacticArchive:HelperIsNew(artCurr)
	local bIsNew = false
...
function CRB_GalacticArchive:HelperIsThereAnyNew()
...
function CRB_GalacticArchive:HelperDrawTypeIcon(wndArg, artCheck, eCategory)
	local strSprite = ""
...
function CRB_GalacticArchive:OnIndexItemUncheck(wndHandler, wndControl) -- ArchiveIndexItem
	if not wndHandler:IsChecked() then
		self:OnBack()
	end
end

function CRB_GalacticArchive:OnIndexItemCheck(wndHandler, wndControl, eMouseButton) -- ArchiveIndexItem
...
function CRB_GalacticArchive:OnGalacticArchiveArticleAdded(artNew)
...
function CRB_GalacticArchive:OnGalacticArchiveEntryAdded(artParent, entNew)
	if not self.wndArchiveIndexForm:IsVisible() then
		return
	end
...
function CRB_GalacticArchive:OnGalacticArchiveRefresh()
	if not self.wndArchiveIndexForm:IsVisible() then
		return
	end
...
-----------------------------------------------------------------------------------------------
-- CRB_GalacticArchiveForm Functions
-----------------------------------------------------------------------------------------------

function CRB_GalacticArchive:DisplayArticle(artDisplay)
...
function CRB_GalacticArchive:DrawEntry(entDraw, wndArticle)
...
function CRB_GalacticArchive:OnBack()
	if not self.artDisplayed then
		return
	end
...
function CRB_GalacticArchive:OnArticleTitleClick(wndHandler, wndControl, eMouseButton)
	if eMouseButton == GameLib.CodeEnumInputMouse.Right and Apollo.IsShiftKeyDown() then
		Event_FireGenericEvent("GenericEvent_ArchiveArticleLink", wndControl:GetData())
	end
end
...
function CRB_GalacticArchive:ReplaceLineBreaks(strArg)
...
function CRB_GalacticArchive:FactoryCacheProduce(wndParent, strFormName, strKey)
...
local CRB_GalacticArchiveInst = CRB_GalacticArchive:new()
CRB_GalacticArchiveInst:Init()
