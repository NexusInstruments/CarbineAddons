-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_GuildDesigner
...
-----------------------------------------------------------------------------------------------
-- CRB_GuildDesigner Module Definition
-----------------------------------------------------------------------------------------------
local CRB_GuildDesigner = {} 
...
-- Initialization
-----------------------------------------------------------------------------------------------
function CRB_GuildDesigner:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self 
...
function CRB_GuildDesigner:Init()
    Apollo.RegisterAddon(self)
end
 
-----------------------------------------------------------------------------------------------
-- CRB_GuildDesigner OnLoad
-----------------------------------------------------------------------------------------------
function CRB_GuildDesigner:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_GuildDesigner.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self) 
end

function CRB_GuildDesigner:OnDocumentReady()
	...
	Apollo.RegisterEventHandler("Event_GuildDesignerOn", 	"OnCRB_GuildDesignerOn", self)
	...
	--Apollo.RegisterEventHandler("GuildRegistrarOpen", 	"OnCRB_GuildDesignerOn", self)	
 	--Apollo.RegisterEventHandler("ToggleGuildDesigner", 	"OnCRB_GuildDesignerOn", self) -- TODO: War Parties NYI  
    
    -- load our forms
    self.wndMain 			= Apollo.LoadForm(self.xmlDoc, "CRB_GuildDesignerForm", nil, self)
...
function CRB_GuildDesigner:OnWindowManagementReady()
	Event_FireGenericEvent("WindowManagementAdd", {wnd = self.wndMain, strName = Apollo.GetString("GuildDesigner_GuildDesigner")})
end

-----------------------------------------------------------------------------------------------
-- CRB_GuildDesigner Functions
-----------------------------------------------------------------------------------------------
-- Define general functions here

function CRB_GuildDesigner:OnCRB_GuildDesignerOn()
	self:SetDefaults()
	self:ResetOptions()
...
---------------------------------------------------------------------------------------------------
function CRB_GuildDesigner:OnWindowClosed(wndHandler, wndControl)
...
function CRB_GuildDesigner:OnCloseVendorWindow()
	self.wndMain:Close() -- just close the window which will trigger OnWindowClosed
end

function CRB_GuildDesigner:SetDefaults()
...
function CRB_GuildDesigner:FormatNoGuild()
...
function CRB_GuildDesigner:ResetOptions()
...
function CRB_GuildDesigner:UpdateOptions()
...
function CRB_GuildDesigner:UpdateCost()
...
-- Holomark Functions
-----------------------------------------------------------------------------------------------
function CRB_GuildDesigner:SetDefaultHolomark()
...
function CRB_GuildDesigner:InitializeHolomarkParts()
...
function CRB_GuildDesigner:OnHolomarkPartCheck1( wndHandler, wndControl, eMouseButton )
...
function CRB_GuildDesigner:OnHolomarkPartUncheck1( wndHandler, wndControl, eMouseButton )
	self.wndMain:FindChild("HolomarkPartWindow.1"):Show(false)
end

function CRB_GuildDesigner:OnHolomarkPartCheck2( wndHandler, wndControl, eMouseButton )
...
function CRB_GuildDesigner:OnHolomarkPartUncheck2( wndHandler, wndControl, eMouseButton )
	self.wndMain:FindChild("HolomarkPartWindow.2"):Show(false)
end

function CRB_GuildDesigner:OnHolomarkPartCheck3( wndHandler, wndControl, eMouseButton )
...
function CRB_GuildDesigner:OnHolomarkPartUncheck3( wndHandler, wndControl, eMouseButton )
	self.wndMain:FindChild("HolomarkPartWindow.3"):Show(false)
end

function CRB_GuildDesigner:FillHolomarkPartList( ePartType )
...
function CRB_GuildDesigner:AddHolomarkPartItem(wndList, index, tPart)
...
function CRB_GuildDesigner:OnHolomarkPartSelectionClosed( wndHandler, wndControl )
...
function CRB_GuildDesigner:OnHolomarkPartItemSelected(wndHandler, wndControl)
...
function CRB_GuildDesigner:IsHolomarkChanged()
...
-----------------------------------------------------------------------------------------------
-- CRB_GuildDesignerForm Functions
-----------------------------------------------------------------------------------------------

-- when the OK button is clicked
function CRB_GuildDesigner:OnCommitBtn(wndHandler, wndControl)  -- TODO!!!
...
function CRB_GuildDesigner:OnCancel(wndHandler, wndControl)
	self:ResetOptions()	
	self.wndMain:Close()
end

function CRB_GuildDesigner:OnResetAllBtn(wndHandler, wndControl)
	self:SetDefaults()
	self.wndRegisterBtn:Enable(false)
end

-- FAILURE ONLY
function CRB_GuildDesigner:OnGuildResultInterceptResponse( guildCurr, eGuildType, eResult, wndRegistration, strAlertMessage )
...
-- SUCCESS ONLY
function CRB_GuildDesigner:OnGuildDesignUpdated(guildUpdated) 
...
function CRB_GuildDesigner:OnGuildDesigner_ModifySuccessfulTimer()
	self.bShowingResult = false
	self.wndAlert:Show(false)
	self:SetDefaults()
end

function CRB_GuildDesigner:OnGuildDesigner_ModifyErrorTimer()
	self.bShowingResult = false
	self.wndAlert:Show(false)
...
function CRB_GuildDesigner:OnGuildInfluenceAndMoney(guildCurr, monInfluence, monCash)
	if guildCurr:GetType() == GuildLib.GuildType_Guild then
		self.wndMain:FindChild("InfluenceAmount"):SetText(guildCurr:GetInfluence())
	end
end

function CRB_GuildDesigner:OnNameChanged(wndHandler, wndControl, strName)
	self:UpdateOptions()
end

-----------------------------------------------------------------------------------------------
-- CRB_GuildDesigner Instance
-----------------------------------------------------------------------------------------------
local CRB_GuildDesignerInst = CRB_GuildDesigner:new()
CRB_GuildDesignerInst:Init()
