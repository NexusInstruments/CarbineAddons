-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_RewardIcons
...
-----------------------------------------------------------------------------------------------
-- CRB_RewardIcons Module Definition
-----------------------------------------------------------------------------------------------
CRB_RewardIcons = {} 
...
-- Initialization
-----------------------------------------------------------------------------------------------
function CRB_RewardIcons:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self 
...
function CRB_RewardIcons:Init()
	Apollo.RegisterAddon(self)
end

-----------------------------------------------------------------------------------------------
-- CRB_RewardIcons OnLoad
-----------------------------------------------------------------------------------------------
function CRB_RewardIcons:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_RewardIcons.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self) 
end

function CRB_RewardIcons:OnDocumentReady()
...
function CRB_RewardIcons:OnKeyBindingUpdated(strKeybind)
...
function CRB_RewardIcons:HelperDrawRewardTooltip(tRewardInfo, wndRewardIcon, strBracketText, strUnitName, tRewardString)
...
function CRB_RewardIcons:HelperDrawBasicRewardTooltip(wndRewardIcon, strBracketText, strUnitName, tRewardString)
...
function CRB_RewardIcons:HelperLoadRewardIcon(wndRewardPanel, eType)
...
function CRB_RewardIcons:HelperDrawRewardIcon(wndRewardIcon)
	if not wndRewardIcon then
		return 0
	end
	local nResult = 0
...
function CRB_RewardIcons:HelperDrawSpellBind(wndIcon, eType)
...
function CRB_RewardIcons:HelperFlagOrDefault(tFlags, strFlagName, default)
...
function CRB_RewardIcons:TableEquals(tData1, tData2)
...
function CRB_RewardIcons:GenerateUnitRewardIconsForm(wndRewardPanel, unitTarget, tFlags)
...
function CRB_RewardIcons:CreateCallNames()
	CRB_RewardIcons.GetUnitRewardIconsForm = function (...)
		CRB_RewardIcons.GenerateUnitRewardIconsForm(self, ...)
	end
end

-----------------------------------------------------------------------------------------------
-- CRB_RewardIcons Instance
-----------------------------------------------------------------------------------------------
local CRB_RewardIconsInst = CRB_RewardIcons:new()
CRB_RewardIconsInst:Init()
