-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_HousingAlerts
...
function CRB_HousingAlerts:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
    return o
...
function CRB_HousingAlerts:Init()
    Apollo.RegisterAddon(self)
end

function CRB_HousingAlerts:OnLoad()
	self.tIntercept = {}
...
-----------------------------------------------------------------------------------------------
-- CRB_HousingAlerts Event Handlers
-----------------------------------------------------------------------------------------------

function CRB_HousingAlerts:OnHousingResultInterceptRequest( wndIntercept, arResultSet )
...
function CRB_HousingAlerts:OnHousingResult( strName, eResult )
...
-----------------------------------------------------------------------------------------------
-- CRB_HousingAlerts Functions
-----------------------------------------------------------------------------------------------

function CRB_HousingAlerts:IsIntercepted( eResult )
...
function CRB_HousingAlerts:GenerateAlert( strName, eResult )
...
-----------------------------------------------------------------------------------------------
-- CRB_HousingAlerts Instance
-----------------------------------------------------------------------------------------------
local CRB_HousingAlertsInst = CRB_HousingAlerts:new()
CRB_HousingAlertsInst:Init()
