-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_LiveEvent
-- Copyright (c) NCsoft. All rights reserved
-----------------------------------------------------------------------------------------------

require "Window"
require "LiveEventsLib"
require "CRB_LiveEvent"
...
function CRB_LiveEvent:Init()
	Apollo.RegisterAddon(self)
end

function CRB_LiveEvent:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_LiveEvent.xml")
	self.xmlDoc:RegisterCallback("OnDocLoaded", self)
end

function CRB_LiveEvent:OnDocLoaded()
...
function CRB_LiveEvent:OnLiveEvent_ToggleWindow()
...
function CRB_LiveEvent:UpdateList() -- Also from one second timer
...
function CRB_LiveEvent:OnPlayerCurrencyChanged()
	if not self.wndMain or not self.wndMain:IsValid() then
		return
	end
...
function CRB_LiveEvent:OnLiveEventHintBtn(wndHandler, wndControl)
	wndHandler:GetData():ShowHintArrow()
end

function CRB_LiveEvent:OnLiveObjectiveHintBtn(wndHandler, wndControl)
	local peEvent = wndHandler:GetData().peEvent
	
	peEvent:ShowHintArrow(wndHandler:GetData().nObjectiveIdx)
end

function CRB_LiveEvent:OnLiveEventClose(wndHandler, wndControl)
...
function CRB_LiveEvent:BuildEventObjectiveTitleString(peoObjective)
...
local CRB_LiveEventInst = CRB_LiveEvent:new()
CRB_LiveEventInst:Init()
