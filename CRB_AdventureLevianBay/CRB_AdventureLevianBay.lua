-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_AdventureLevianBay
-- Copyright (c) NCsoft. All rights reserved
-----------------------------------------------------------------------------------------------
 
require "Window"
 
local CRB_AdventureLevianBay = {} 
...
function CRB_AdventureLevianBay:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
...
function CRB_AdventureLevianBay:Init()
	Apollo.RegisterAddon(self)
end
 
function CRB_AdventureLevianBay:OnLoad()
    self.xmlDoc = XmlDoc.CreateFromFile("CRB_AdventureLevianBay.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)
	
	Apollo.RegisterEventHandler("ChangeWorld", "HideUI", self)
end

function CRB_AdventureLevianBay:OnDocumentReady()
...
function CRB_AdventureLevianBay:ShowUI()
...
function CRB_AdventureLevianBay:HideUI()
...
function CRB_AdventureLevianBay:AdvLevianBayProgress(nSetPiece)
	self:ShowUI()
...
function CRB_AdventureLevianBay:UpdatePosition(nTeam, nLeg, nPosition, bIsDead)
	self:ShowUI()
...
function CRB_AdventureLevianBay:TeamDead(nTeam)
	self:ShowUI()
...
local CRB_AdventureLevianBayInst = CRB_AdventureLevianBay:new()
