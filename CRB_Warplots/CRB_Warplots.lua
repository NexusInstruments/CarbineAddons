-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_Warplots
...
function CRB_Warplots:Init()
	Apollo.RegisterAddon(self)
end

function CRB_Warplots:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_Warplots.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)
end

function CRB_Warplots:OnDocumentReady()
...
function CRB_Warplots:OnChangeWorld()
	self.wndMain:Show(false)
	Apollo.StopTimer("WarPlot_OneSecMatchTimer")
	self.peMatch = nil
end

function CRB_Warplots:OnWarPlotOneSecMatchTimer()	
...
function CRB_Warplots:DrawEnergy(peoEnergy, wndBar, wndProgress)
...
function CRB_Warplots:DrawGenerator(peoGenerator, wndParent, strTeamColor)
...
function CRB_Warplots:DrawControlPoint(peoControlPoint, wndPoint, nIndex)		
	wndPoint:SetMax(100)
...
function CRB_Warplots:CheckForWarplot()
...
local CRB_WarplotsInstance = CRB_Warplots:new()
