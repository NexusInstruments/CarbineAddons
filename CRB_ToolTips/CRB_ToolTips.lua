-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_ToolTips
...
function CRB_ToolTips:Init()
	Apollo.RegisterAddon(self)
end

function CRB_ToolTips:OnLoad()
    self.xmlDoc = XmlDoc.CreateFromFile("TooltipsForms.xml")
    self.xmlDoc:RegisterCallback("OnDocumentReady", self)
end

function CRB_ToolTips:OnDocumentReady()
...
function CRB_ToolTips:OnPlayerRealmName(unit, strRealmName)
...
function CRB_ToolTips:AddTimedWindow(nStartValue, nStepValue, nStopValue, strDisplayFormat, wndTimed)
	if #self.tTimedWindows == 0 then
...
function CRB_ToolTips:UnitTooltipGen(wndContainer, unitSource, strProp)
...
function CRB_ToolTips:OnUpdateVitals()
	tVitals = Unit.GetVitalTable()
end
...
function CRB_ToolTips:HelperCalculateConValue(unitTarget)
...
function CRB_ToolTips:CreateCallNames()
...
function CRB_ToolTips:OnGenerateWorldObjectTooltip( wndHandler, wndControl, eToolTipType, unit, strPropName )
...
function CRB_ToolTips:OnMouseOverUnitChanged(unit)
	self:UnitTooltipGen(GameLib.GetWorldTooltipContainer(), unit, "")
end

local ToolTipInstance = CRB_ToolTips:new()
