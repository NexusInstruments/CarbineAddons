-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_RaidFrameMasterLoot
-- Copyright (c) NCsoft. All rights reserved
-----------------------------------------------------------------------------------------------

require "Window"

local CRB_RaidFrameMasterLoot = {}

function CRB_RaidFrameMasterLoot:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
    return o
...
function CRB_RaidFrameMasterLoot:Init()
    Apollo.RegisterAddon(self)
end

function CRB_RaidFrameMasterLoot:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_RaidFrameMasterLoot.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self) 
end

function CRB_RaidFrameMasterLoot:OnDocumentReady()
...
function CRB_RaidFrameMasterLoot:Initialize(bShow)
	...
	self.wndMain = Apollo.LoadForm(self.xmlDoc, "CRB_RaidFrameMasterLootForm", nil, self)
...
function CRB_RaidFrameMasterLoot:InitializeGroupSettings()
...
function CRB_RaidFrameMasterLoot:OnSetLootUnderThresCheck(wndHandler, wndControl)
	local tLootRules =
	{
...
function CRB_RaidFrameMasterLoot:OnSetLootOverThresCheck(wndHandler, wndControl)
	local tLootRules =
	{
...
function CRB_RaidFrameMasterLoot:OnSetHarvestRulesCheck(wndHandler, wndControl)
	local tLootRules =
	{
...
function CRB_RaidFrameMasterLoot:OnSetLootItemThresCheck(wndHandler, wndControl)
	local tItemMapping =
	{
...
function CRB_RaidFrameMasterLoot:OnOptionsCloseBtn()
	if self.wndMain and self.wndMain:IsValid() then
		self.wndMain:Destroy()
...
function CRB_RaidFrameMasterLoot:FactoryProduce(wndParent, strFormName, tObject)
...
local CRB_RaidFrameMasterLootInst = CRB_RaidFrameMasterLoot:new()
CRB_RaidFrameMasterLootInst:Init()
