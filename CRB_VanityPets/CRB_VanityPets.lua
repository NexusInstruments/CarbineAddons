-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_VanityPets
...
-----------------------------------------------------------------------------------------------
-- CRB_VanityPets Module Definition
-----------------------------------------------------------------------------------------------
local CRB_VanityPets = {} 

local kstrContainerEventName = "CRB_VanityPets"
 
-----------------------------------------------------------------------------------------------
-- Initialization
-----------------------------------------------------------------------------------------------
function CRB_VanityPets:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self 
...
-----------------------------------------------------------------------------------------------
-- CRB_VanityPets OnLoad
-----------------------------------------------------------------------------------------------
function CRB_VanityPets:OnLoad()
    -- load our form file
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_VanityPets.xml")
	self.xmlDoc:RegisterCallback("OnDocLoaded", self)
end

-----------------------------------------------------------------------------------------------
-- CRB_VanityPets OnDocLoaded
-----------------------------------------------------------------------------------------------
function CRB_VanityPets:OnDocLoaded()
...
-----------------------------------------------------------------------------------------------
-- CRB_VanityPets Functions
-----------------------------------------------------------------------------------------------
function CRB_VanityPets:OnRegisterContainer(wndParent)
...
function CRB_VanityPets:OnClose()
...
function CRB_VanityPets:OnPetsShow()
...
function CRB_VanityPets:OnPetsHide()
	self.wndMain:Show(false)
end

function CRB_VanityPets:UpdatePetLists()
	if not self.wndMain then
		return
	end
...
function CRB_VanityPets:OnPetItemClick(wndHandler, wndControl)
...
function CRB_VanityPets:OnSummonPet(wndHandler, wndControl)
...
function CRB_VanityPets:OnRotateLeft( wndHandler, wndControl, eMouseButton )
	self.wndMain:FindChild("PetPreview"):ToggleRightSpin(true)
end

function CRB_VanityPets:OnRotateLeftCancel( wndHandler, wndControl, eMouseButton )
	self.wndMain:FindChild("PetPreview"):ToggleRightSpin(false)
end

function CRB_VanityPets:OnRotateRight( wndHandler, wndControl, eMouseButton )
	self.wndMain:FindChild("PetPreview"):ToggleLeftSpin(true)
end

function CRB_VanityPets:OnRotateRightCancel( wndHandler, wndControl, eMouseButton )
	self.wndMain:FindChild("PetPreview"):ToggleLeftSpin(false)
end

function CRB_VanityPets:OnHideUnknown()
	for idx, wndPet in pairs(self.tUnknownPets) do
		wndPet:Show(false)
	end
...
function CRB_VanityPets:OnShowUnknown()
	for idx, wndPet in pairs(self.tUnknownPets) do
...
function CRB_VanityPets:OnPetBeginDragDrop(wndHander, wndControl)
	Apollo.BeginDragDrop(wndHander, "DDNonCombat", wndHander:GetSprite(), wndHander:GetData())
end

function CRB_VanityPets:OnSearchFieldChanged(wndHandler, wndControl, strText)
	local wndPetList = self.wndMain:FindChild("PetList")
...
function CRB_VanityPets:OnClearSearch(wndHandler, wndControl)
...
function CRB_VanityPets:ArrangeList()
	local wndPetList = self.wndMain:FindChild("PetList")
...
-----------------------------------------------------------------------------------------------
-- CRB_VanityPets Instance
-----------------------------------------------------------------------------------------------
local PetsInst = CRB_VanityPets:new()
PetsInst:Init()
