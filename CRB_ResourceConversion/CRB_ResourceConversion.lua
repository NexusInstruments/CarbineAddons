-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_ResourceConversion
...
local CRB_ResourceConversion = {}
local kTickDuration = .25

function CRB_ResourceConversion:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
    return o
...
function CRB_ResourceConversion:Init()
    Apollo.RegisterAddon(self)
end

function CRB_ResourceConversion:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_ResourceConversion.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self) 
end

function CRB_ResourceConversion:OnDocumentReady()
...
function CRB_ResourceConversion:OnCloseBtn() -- Also WindowClosed and "ResourceConversionClose"
...
function CRB_ResourceConversion:OnUpdateInventory()
...
function CRB_ResourceConversion:OnResourceConversionOpen(unitVendor)
	if self.wndMain then
		self.wndMain:Destroy()
	end

	self.wndMain = Apollo.LoadForm(self.xmlDoc, "CRB_ResourceConversionForm", nil, self)
...
-----------------------------------------------------------------------------------------------
function CRB_ResourceConversion:OnConversionAddBtn(wndHandler, wndControl)
...
function CRB_ResourceConversion:OnConversionSubBtn(wndHandler, wndControl)
	local wndConversionContainer = wndHandler:GetData()
...
function CRB_ResourceConversion:OnConversionLeftEditBoxChanged(wndHandler, wndControl, strNew)
	local wndConversionContainer = wndHandler:GetData()
...
function CRB_ResourceConversion:OnMainSliderChanged(wndHandler, wndControl, fValue) -- MainSlider
	local wndConversionContainer = wndHandler:GetData()
...
function CRB_ResourceConversion:UpdateConversionWindow(wndConversionItem, nConversionCount)
...
function CRB_ResourceConversion:OnConversionBtn(wndHandler, wndControl) -- ConversionBtn
	local wndConversionContainer = wndHandler:GetData()
...
function CRB_ResourceConversion:HelperBuildItemTooltip(wndArg, itemCurr)
...
local CRB_ResourceConversionInst = CRB_ResourceConversion:new()
