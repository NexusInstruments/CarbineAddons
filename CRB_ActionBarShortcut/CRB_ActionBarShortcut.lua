-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_ActionBarShortcut
...
function CRB_ActionBarShortcut:new(o)
	o = o or {}
	setmetatable(o, self)
	self.__index = self
...
function CRB_ActionBarShortcut:Init()
	Apollo.RegisterAddon(self, nil, nil, {"ActionBarFrame"})
end

function CRB_ActionBarShortcut:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_ActionBarShortcut.xml")
...
function CRB_ActionBarShortcut:OnSave(eType)
...
function CRB_ActionBarShortcut:OnRestore(eType, tSavedData)
...
function CRB_ActionBarShortcut:OnDocumentReady()
	...
	for idx = knStartingBar, knMaxBars do
		local wndCurrBar = Apollo.LoadForm(self.xmlDoc, "CRB_ActionBarShortcut", "FixedHudStratum", self)
...
function CRB_ActionBarShortcut:GetBarPosition(wndBar)
	if not wndBar then
		return {}
	end
...
function CRB_ActionBarShortcut:SetBarPosition(wndBar, tArgSize, tArgCenter)
...
function CRB_ActionBarShortcut:ShowBarDocked(nBar, bIsVisible, nShortcuts)
...
function CRB_ActionBarShortcut:ShowBarFloatHorz(nBar, bIsVisible, nShortcuts)
	-- set the position of this action bar ignoring overlapping
...
function CRB_ActionBarShortcut:ShowBarFloatVert(nBar, bIsVisible, nShortcuts)
	-- set the position of this action bar ignoring overlapping
...
function CRB_ActionBarShortcut:ShowWindow(nBar, bIsVisible, nShortcuts)
...
function CRB_ActionBarShortcut:OnActionBarShortcutArtTimer()
	self.bTimerRunning = false
...
function CRB_ActionBarShortcut:OnDockBtn(wndControl, wndHandler)
...
function CRB_ActionBarShortcut:OnOrientationBtn(wndControl, wndHandler)
	self.bDocked = false
...
function CRB_ActionBarShortcut:OnGenerateTooltip(wndControl, wndHandler, eType, oArg1, oArg2)
	local xml = nil
...
-----------------------------------------------------------
local ActionBarShortcut_Singleton = CRB_ActionBarShortcut:new()
