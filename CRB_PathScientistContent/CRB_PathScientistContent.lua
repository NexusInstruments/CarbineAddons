-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_PathScientistContent
...
local CRB_PathScientistContent = {}
...
function CRB_PathScientistContent:new(o)
	o = o or {}
	setmetatable(o, self)
	self.__index = self
...
function CRB_PathScientistContent:Init()
	Apollo.RegisterAddon(self)
end

function CRB_PathScientistContent:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_PathScientistContent.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)

	Apollo.RegisterEventHandler("SetPlayerPath", "OnSetPlayerPath", self)
end

function CRB_PathScientistContent:OnSetPlayerPath()
...
function CRB_PathScientistContent:OnSave(eType)
...
function CRB_PathScientistContent:OnRestore(eType, tSavedData)
...
function CRB_PathScientistContent:OnDocumentReady()
	if self.xmlDoc == nil then return end
	
	self:OnPathLoaded()
end

function CRB_PathScientistContent:OnPathLoaded()
...
function CRB_PathScientistContent:OnObjectiveTrackerLoaded(wndForm)
...
function CRB_PathScientistContent:UpdateUITimer()
...
function CRB_PathScientistContent:OnPlayerPathMissionUnlocked(pmMission) -- new mission, so we want to add a runner
	local tMissionInfo =
	{
		pmMission 	= pmMission,
		nCount 		= 0,
...
function CRB_PathScientistContent:OnScientistScanData(tScannedUnits)
...
function CRB_PathScientistContent:OnMouseEnter(wndHandler, wndControl)
...
function CRB_PathScientistContent:OnMouseExit(wndHandler, wndControl)
	if wndHandler:GetId() ~= wndControl:GetId() then
		return
	end
...
function CRB_PathScientistContent:OnControlBackerMouseEnter(wndHandler, wndControl)
	if wndHandler == wndControl then
		wndHandler:FindChild("MinimizeBtn"):Show(true)
	end
end

function CRB_PathScientistContent:OnControlBackerMouseExit(wndHandler, wndControl)
	if wndHandler == wndControl then
...
function CRB_PathScientistContent:OnMinimizedBtnChecked(wndHandler, wndControl, eMouseButton)
...
function CRB_PathScientistContent:OnPlayerPathScientistScanBotCooldown(fTime) -- iTime is cooldown time in MS (5250)
...
function CRB_PathScientistContent:OnIncrementScanBotCoolDown()
...
function CRB_PathScientistContent:OnScanBotCoolDownTimer()
...
function CRB_PathScientistContent:OnPathUpdate()
...
function CRB_PathScientistContent:OnResizeContainer(wndContainer)
...
function CRB_PathScientistContent:OnLocateBtn()
...
function CRB_PathScientistContent:DrawListItem(wndListItem, pmMission)
...
function CRB_PathScientistContent:DrawBotButtons()
...
function CRB_PathScientistContent:OnScanBtn()
	if PlayerPathLib.GetPlayerPathType() == PlayerPathLib.PlayerPathType_Scientist then
...
function CRB_PathScientistContent:OnOpenConfigureScreenBtn()
	Event_FireGenericEvent("GenericEvent_ToggleScanBotCustomize")
end

function CRB_PathScientistContent:OnListItemSubscreenBtn(wndHandler, wndControl) -- wndHandler is ListItemSubscreenBtn and its data is a mission
...
function CRB_PathScientistContent:OnCollapseChecklistClick()
...
function CRB_PathScientistContent:OnSummonBotMouseEnter(wndHandler, wndControl)
...
function CRB_PathScientistContent:OnSummonBotMouseExit(wndHandler, wndControl)
	wndHandler:SetText("")
end

function CRB_PathScientistContent:OnSummonBotBtn(wndHandler, wndControl)
	PlayerPathLib.ScientistToggleScanBot()
end

function CRB_PathScientistContent:OnListItemMouseEnter(wndHandler, wndControl)
	-- Has Mouse
...
function CRB_PathScientistContent:OnListItemMouseExit(wndHandler, wndControl)
	-- Has Mouse
	local bHasMouse = wndControl:GetParent():FindChild("ListItemMouseCatcher"):ContainsMouse()
	wndControl:GetParent():FindChild("ListItemCodexBtn"):Show(bHasMouse)
...
function CRB_PathScientistContent:OnListItemHintArrow(wndControl, wndHandler)
...
function CRB_PathScientistContent:OnListItemOpenCodex(wndHandler, wndControl)
...
function CRB_PathScientistContent:OnListIconEnter(wndHandler, wndControl)
	if wndControl ~= wndHandler then return end
	--wndControl:FindChild("ListItemIconText"):SetText("?")
end

function CRB_PathScientistContent:OnListIconExit(wndHandler, wndControl)
	if wndControl ~= wndHandler then return end
	--wndControl:FindChild("ListItemIconText"):SetText("")
end

function CRB_PathScientistContent:OnLootEpisodeBtn(wndHandler, wndControl)
...
function CRB_PathScientistContent:PopulateChecklistContainer(pmStudy)
	if not pmStudy then
		return
	end
...
function CRB_PathScientistContent:OnScientistChecklistItemBtn(wndHandler, wndControl)
...
function CRB_PathScientistContent:HelperGetMissionName(strName)
...
function CRB_PathScientistContent:FactoryProduce(wndParent, strFormName, tObject)
...
-- Right Click
-----------------------------------------------------------------------------------------------
function CRB_PathScientistContent:CloseContextMenu() -- From a variety of source
...
function CRB_PathScientistContent:DrawContextMenu()
...
function CRB_PathScientistContent:DrawContextMenuSubOptions(wndIgnore)
...
function CRB_PathScientistContent:OnToggleShowPathMissions()
...
function CRB_PathScientistContent:OnToggleFilterZone()
...
function CRB_PathScientistContent:OnToggleFilterLimit()
...
function CRB_PathScientistContent:OnToggleFilterDistance()
...
function CRB_PathScientistContent:OnMissionLimitEditBoxChanged(wndHandler, wndControl)
...
function CRB_PathScientistContent:OnMissionDistanceEditBoxChanged(wndHandler, wndControl)
	if wndHandler ~= wndControl then return end
...
local CRB_PathScientistContentInst = CRB_PathScientistContent:new()
CRB_PathScientistContentInst:Init()
