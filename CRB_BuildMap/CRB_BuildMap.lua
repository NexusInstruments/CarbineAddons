-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_BuildMap
...
function CRB_BuildMap:Init()
    Apollo.RegisterAddon(self)
end

function CRB_BuildMap:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_BuildMap.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self) 
end

function CRB_BuildMap:OnDocumentReady()
...
function CRB_BuildMap:Initialize()
	...
	self.wndMain = Apollo.LoadForm(self.xmlDoc, "CRB_BuildMapForm", nil, self)
...
function CRB_BuildMap:OnSave(eType)
...
function CRB_BuildMap:OnRestore(eType, tData)
...
function CRB_BuildMap:OnSettlerBuildStatusUpdate(nHub, unitDepot)
	
end

function CRB_BuildMap:OnInvokeSettlerBuild(unitPlayer, tList)
...
function CRB_BuildMap:RedrawSelectionItems()
...
function CRB_BuildMap:DrawTierSettler(setNode)
...
function CRB_BuildMap:OnCategoryFilterBtnCheck(wndHandler, wndControl)
	self.wndMain:FindChild("BottomSection:SelectionItemContainer"):DestroyChildren()
	self:HideMapHover()
	self:OnSettlerHubUpdated()
end

function CRB_BuildMap:OnCategoryFilterBtnUncheck(wndHandler, wndControl)
...
function CRB_BuildMap:OnSettlerHubUpdated()
	if self.wndMain and self.wndMain:IsValid() and self.wndMain:IsShown() then
		self:RedrawSelectionItems()
	end
end

function CRB_BuildMap:OnPlayerIndicatorUpdated()
...
function CRB_BuildMap:OnSelectionItemShowExtraInfo(wndHandler, wndControl) -- SelectionItemBtn, data is { tNode, nTier, tCurrTier, wndSelectionItem }
...
function CRB_BuildMap:OnSelectionItemPopOutClosed(wndHandler, wndControl)
	wndHandler:Destroy()
end

function CRB_BuildMap:OnPopoutBuildBtn(wndHandler, wndControl) -- PopoutBuildBtn, data is { node, tier }
...
function CRB_BuildMap:ShowMapHover(setNode)
...
function CRB_BuildMap:HideMapHover() -- Also SelectionItemBtn uncheck
	if self.wndLastMouseEnter then
		self.wndMain:FindChild("TopSection:WorldMap"):RemoveObject(self.wndLastMouseEnter)
	end
end
...
function CRB_BuildMap:OnWindowClosed()
	Event_CancelSettlerHub()
end

function CRB_BuildMap:OnCloseVendorWindow()
...
function CRB_BuildMap:OnCloseBtn() -- SettlerBuildResult
	if self.wndMain ~= nil and self.wndMain:IsValid() then	
		self.locSavedWindowLoc = self.wndMain:GetLocation()
		self.wndMain:Destroy()
		self.wndMain = nil
...
function CRB_BuildMap:HelperConvertToTime(nArg)
...
function CRB_BuildMap:HelperBuildItemTooltip(wndArg, itemCurr)
...
function CRB_BuildMap:FactoryProduce(wndParent, strFormName, tObject)
...
---------------------------------------------------------------------------------------------------
-- CRB_BuildMapForm Functions
---------------------------------------------------------------------------------------------------

function CRB_BuildMap:OnKeepWindowBtnCheck( wndHandler, wndControl, eMouseButton )
	self.bKeepWindowOpen = wndControl:IsChecked()
end

local CRB_BuildMapInst = CRB_BuildMap:new()
CRB_BuildMapInst:Init()
