...
function CRB_Hazards:Init()
	Apollo.RegisterAddon(self)
end

function CRB_Hazards:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_Hazards.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)
end

function CRB_Hazards:OnDocumentReady()
...
function CRB_Hazards:BuildInterface()
...
function CRB_Hazards:ClearInterface()
...
function CRB_Hazards:OnHazardEnable(idHazard, strDisplayTxt)
	self:SetupHazardWindow(idHazard, strDisplayTxt)
	self:OnHazardsUpdated()
end

function CRB_Hazards:BuildHazardWindow(idHazard, eHazardType)
	self:BuildInterface()
...
function CRB_Hazards:SetupHazardWindow(idHazard, strDisplayTxt)
...
function CRB_Hazards:OnHazardRemove(idHazard)
...
function CRB_Hazards:OnHazardsUpdated()
	local bNew = false
	for idx, tData in ipairs(HazardsLib.GetHazardActiveList()) do
...
function CRB_Hazards:OnHazardUpdate(idHazard, eHazardType, fMeterValue, fMaxValue, strTooltip)
...
function CRB_Hazards:OnBreathChanged(nBreath)
...
function CRB_Hazards:OnBreath_FlashEvent()
...
local HazardInst = CRB_Hazards:new()
