-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_ReportPlayer
...
local CRB_ReportPlayer = {}

function CRB_ReportPlayer:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
    return o
...
function CRB_ReportPlayer:Init()
    Apollo.RegisterAddon(self)
end

function CRB_ReportPlayer:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_ReportPlayer.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)
end

function CRB_ReportPlayer:OnDocumentReady()
...
function CRB_ReportPlayer:OnInterfaceMenuListHasLoaded()
...
function CRB_ReportPlayer:OnReportPlayerPvP(rptParticipant)
	self:BuildReportConfirmation(rptParticipant, Apollo.GetString("ReportPlayer_GenericReportUnavailable"))
end

function CRB_ReportPlayer:OnReportPlayerUnit(unitTarget)
...
function CRB_ReportPlayer:OnReportPlayerChat(nReportId)
...
function CRB_ReportPlayer:OnReportPlayerMail(msgMail)
...
function CRB_ReportPlayer:OnReportPlayerFriendInvite(nInviteId)
...
function CRB_ReportPlayer:OnReportPlayerGuildInvite() -- GOTCHA: Includes Circle, Warparties, and Arena (as they are all guild lib)
...
function CRB_ReportPlayer:OnToggleFromInterfaceMenu()
...
function CRB_ReportPlayer:OnCustomInputEditBoxChanged(wndHandler, wndControl)
...
function CRB_ReportPlayer:OnNameSelectedBtn(wndHandler, wndControl)
...
function CRB_ReportPlayer:BuildReportConfirmation(rptInfraction, strFail, unitTarget) -- rptInfraction can be nil
	...
	if rptInfraction then
		...
		wndCurr:FindChild("YesButton"):SetActionData(GameLib.CodeEnumConfirmButtonType.CRB_ReportPlayer, rptInfraction)
	end
...
function CRB_ReportPlayer:OnIgnorePlayerCheckboxToggle(wndHandler, wndControl)
...
function CRB_ReportPlayer:OnReportReasonChange(wndHandler, wndControl)
	...
	self.wndMain:FindChild("YesButton"):SetActionData(GameLib.CodeEnumConfirmButtonType.CRB_ReportPlayer, rptInfraction)
end

function CRB_ReportPlayer:OnReportPlayerComplete(wndHandler, wndControl)
...
function CRB_ReportPlayer:OnOptionsOpenSupportBtn(wndHandler, wndControl)
...
function CRB_ReportPlayer:ReportChat_WindowClosed(wndHandler)
	self:ClearReportConfirmation()
end

function CRB_ReportPlayer:ReportChat_NoPicked(wndHandler, wndControl)
	self:ClearReportConfirmation()
end

function CRB_ReportPlayer:ClearReportConfirmation() -- From a variety of sources
	if self.wndMain and self.wndMain:IsValid() then
...
function CRB_ReportPlayer:OnNamePickerClose() -- From a variety of sources
	if self.wndNamePicker and self.wndNamePicker:IsValid() then
		self.wndNamePicker:Destroy()
		self.wndNamePicker = nil
	end
...
function CRB_ReportPlayer:OnReportPlayer_OneSecondTimer()
...
local CRB_ReportPlayerInst = CRB_ReportPlayer:new()
CRB_ReportPlayerInst:Init()
