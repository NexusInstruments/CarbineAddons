-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_AbilityVendor
...
function CRB_AbilityVendor:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
...
function CRB_AbilityVendor:Init()
    Apollo.RegisterAddon(self)
end

function CRB_AbilityVendor:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_AbilityVendor.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self) 
end

function CRB_AbilityVendor:OnDocumentReady()
...
function CRB_AbilityVendor:OnSave(eType)
...
function CRB_AbilityVendor:OnRestore(eType, tSavedData)
...
function CRB_AbilityVendor:OnClose(wndHandler, wndControl)
...
function CRB_AbilityVendor:OnAbilityVendorToggle(bAtVendor)
	...
	if self.tWndRefs.wndMain and self.tWndRefs.wndMain:IsValid() then
		...
		self.tWndRefs.wndMain = Apollo.LoadForm(self.xmlDoc, "CRB_AbilityVendorForm", nil, self)
	end
...
function CRB_AbilityVendor:RedrawAll()
...
function CRB_AbilityVendor:RedrawRespec()
	if not self.tWndRefs.wndMain or not self.tWndRefs.wndMain:IsValid() then
		return
	end
...
function CRB_AbilityVendor:OnBuyBtn(wndHandler, wndControl) -- BuyBtn
...
function CRB_AbilityVendor:OnAbilityItemToggle(wndHandler, wndControl) -- AbilityItemBtn, data is abilityId
	local wndBuyBtn = self.tWndRefs.wndBuyBtn
	wndBuyBtn:SetData(wndHandler:GetData())
	wndBuyBtn:Enable(wndHandler:IsChecked())
end

local CRB_AbilityVendorInst = CRB_AbilityVendor:new()
CRB_AbilityVendorInst:Init()
