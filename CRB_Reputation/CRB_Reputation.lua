-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_Reputation
...
function CRB_Reputation:Init()
    Apollo.RegisterAddon(self)
end

-----------------------------------------------------------------------------------------------
-- CRB_Reputation OnLoad
-----------------------------------------------------------------------------------------------

function CRB_Reputation:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_Reputation.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)
end

function CRB_Reputation:OnDocumentReady()
...
function CRB_Reputation:OnGenericEvent_InitializeReputation(wndParent)
    ...
    self.wndMain = Apollo.LoadForm(self.xmlDoc, "CRB_ReputationForm", wndParent, self)
...
-----------------------------------------------------------------------------------------------
-- CRB_Reputation Functions
-----------------------------------------------------------------------------------------------

function CRB_Reputation:OnReputationChanged(tFaction)
...
function CRB_Reputation:OnGenericEvent_DestroyReputation()
	if self.wndMain and self.wndMain:IsValid() then
...
function CRB_Reputation:ResetData()
	self.tStrToWndMapping = {}
	self.wndMain:FindChild("FactionList"):DestroyChildren()
end

function CRB_Reputation:SortReps(tRepTable)
	self.tTopLabels = {}
	self.tSubLabels = {}
	self.tProgress = {}
...
function CRB_Reputation:PopulateFactionList()
...
function CRB_Reputation:BuildFaction(tFaction, wndParent)
...
function CRB_Reputation:BuildTopLevel(wndCurr, tFaction)
	wndCurr:FindChild("ItemsBtn"):SetCheck(true)
	wndCurr:FindChild("ItemsBtnText"):SetText(tFaction.strName)
...
function CRB_Reputation:BuildListItemProgress(wndCurr, tFaction)
	local tLevelData = self.tReputationLevels[tFaction.nLevel]
...
function CRB_Reputation:OnTopLevelToggle(wndHandler, wndControl) -- wndHandler is "ListItemTopLevel's ItemsBtn"
	self:ResizeItemContainer()
end

function CRB_Reputation:OnMiddleLevelLabelToggle(wndHandler, wndControl) -- wndHandler "ListItemLabel's ItemsBtn"
	self:ResizeItemContainer()
end

function CRB_Reputation:ResizeItemContainer()
...
local CRB_ReputationInst = CRB_Reputation:new()
CRB_ReputationInst:Init()
