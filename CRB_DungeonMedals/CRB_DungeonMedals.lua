...
function CRB_DungeonMedals:new(o)
	o = o or {}
	setmetatable(o, self)
	self.__index = self
	return o
...
function CRB_DungeonMedals:Init()
	Apollo.RegisterAddon(self)
end

function CRB_DungeonMedals:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_DungeonMedals.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)
	
	self:InitializeVars()
end

function CRB_DungeonMedals:InitializeVars()
	self.nTimeElapsed = 0
	self.nPointDelta = 0
	self.nPoints	= 0
	self.nBronze = 0
...
function CRB_DungeonMedals:OnDocumentReady()
...
function CRB_DungeonMedals:Reset()
...
function CRB_DungeonMedals:OnDungeons_IncreasePoints(nPoints)
...
function CRB_DungeonMedals:UpdatePoints()
...
function CRB_DungeonMedals:OnPointsCleanUpTimer()
...
function CRB_DungeonMedals:OnOneSecTimer()
...
function CRB_DungeonMedals:CheckForDungeon()
...
local CRB_DungeonMedalsInstance = CRB_DungeonMedals:new()
