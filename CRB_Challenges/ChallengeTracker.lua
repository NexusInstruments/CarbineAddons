...
local kstrObjectiveType =  Apollo.GetString("CRB_Challenges")
...
{
	[0] = "CRB_Challenges:sprChallenges_starBlack",
	[1] = "CRB_Challenges:sprChallenges_starBronze",
	[2] = "CRB_Challenges:sprChallenges_starSilver",
	[3] = "CRB_Challenges:sprChallenges_starGold",
}
