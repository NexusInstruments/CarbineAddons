...
function CRB_MessageManager:new(o)
	o = o or {}
	setmetatable(o, self)
	self.__index = self
...
function CRB_MessageManager:Init()
	Apollo.RegisterAddon(self)
end

---------------------------------------------------------------------------------------------------
function CRB_MessageManager:OnLoad()
...
---------------------------------------------------------------------------------------------------
function CRB_MessageManager:OnFrameUpdate()
...
function CRB_MessageManager:RequestShowTextFloater(eMessageType, tParams, tContent)
...
function CRB_MessageManager:UpdateOrAddXpFloater(eMessageType, tParams, tContent)
...
function CRB_MessageManager:UpdateOrAddAlternateCurrencyFloater(eMessageType, tParams, tContent)
...
function CRB_MessageManager:UpdateOrAddPathXpFloater(eMessageType, tParams, tContent)
...
function CRB_MessageManager:UpdateOrAddRepFloater(eMessageType, tParams, tContent)	
...
function CRB_MessageManager:RequestShowWindow(eMessageType, wndMessage)
    local tParams = 
	{
...
function CRB_MessageManager:RequestShowAlert(eMessageType, tParams)
    tParams.eDisplayType = LuaEnumMessageDisplayType.Alert 
    self:RequestShowMessage(eMessageType, tParams)
end

---------------------------------------------------------------------------------------------------
function CRB_MessageManager:RequestShowMessage(eMessageType, tParams)
...
---------------------------------------------------------------------------------------------------
function CRB_MessageManager:ShowMessage(eMessageType, tParams)
    local eField = ktMessageSettings[eMessageType].eField
...
---------------------------------------------------------------------------------------------------
function CRB_MessageManager:HideMessage(eField)
...
---------------------------------------------------------------------------------------------------
function CRB_MessageManager:OnHideText() -- for testing
...
---------------------------------------------------------------------------------------------------
function CRB_MessageManager:OnMessageFinished(oMessage)
...
---------------------------------------------------------------------------------------------------
-- CRB_MessageManager instance
---------------------------------------------------------------------------------------------------
local CRB_MessageManagerInst = CRB_MessageManager:new()
CRB_MessageManagerInst:Init()
