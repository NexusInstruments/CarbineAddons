-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_ObjectiveTracker
...
local CRB_ObjectiveTracker = {}

function CRB_ObjectiveTracker:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self
...
function CRB_ObjectiveTracker:Init()
    Apollo.RegisterAddon(self)
end

function CRB_ObjectiveTracker:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_ObjectiveTracker.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self)
end

function CRB_ObjectiveTracker:OnSave(eType)
...
function CRB_ObjectiveTracker:OnRestore(eType, tSavedData)
	if eType ~= GameLib.CodeEnumAddonSaveLevel.Character then
		return
	end
...
function CRB_ObjectiveTracker:OnDocumentReady()
    ...
    self.wndMain = Apollo.LoadForm(self.xmlDoc, "CRB_ObjectiveTrackerForm", "FixedHudStratum", self)
...
function CRB_ObjectiveTracker:OnRedrawTimer()
...
function CRB_ObjectiveTracker:HelperConstructDataBtnAdded(wndButton)
...
function CRB_ObjectiveTracker:OnBackgroundMouse(wndHandler, wndControl)
...
function CRB_ObjectiveTracker:OnOptionsUpdated()
...
function CRB_ObjectiveTracker:OnAddonNew(tAddonSettings)
...
function CRB_ObjectiveTracker:OnAddonRemoved(tAddonSettings)
...
function CRB_ObjectiveTracker:OnAddonUpdate(tAddonSettings)
...
function CRB_ObjectiveTracker:OnResizeAll()
...
function CRB_ObjectiveTracker:OnListBtnClick(wndHandler, wndControl, eMouseButton)
...
-- Right Click
-----------------------------------------------------------------------------------------------
function CRB_ObjectiveTracker:CloseContextMenu() -- From a variety of source
...
function CRB_ObjectiveTracker:DrawContextMenu()
...
function CRB_ObjectiveTracker:OnToggleQuestTrackerByDistance(wndHandler, wndControl)
...
function CRB_ObjectiveTracker:OnToggleQuestTrackerAlignTop(wndHandler, wndControl)
	g_InterfaceOptions.Carbine.bQuestTrackerAlignBottom = not wndHandler:IsChecked()
	Event_FireGenericEvent("OptionsUpdated_QuestTracker")
end

function CRB_ObjectiveTracker:OnToggleQuestTrackerAlignBottom(wndHandler, wndControl)
	g_InterfaceOptions.Carbine.bQuestTrackerAlignBottom = wndHandler:IsChecked()
	Event_FireGenericEvent("OptionsUpdated_QuestTracker")
end

function CRB_ObjectiveTracker:OnToggleQuestShowButtons(wndHandler, wndControl)
	self.bShowButtonsOnMouseOver = wndHandler:IsChecked()
	
	self.wndButtonContainer:Show(not self.bShowButtonsOnMouseOver)
end

function CRB_ObjectiveTracker:OnOpacitySliderBarChanged(wndHandler, wndControl, fValue, fOldValue)
...
function CRB_ObjectiveTracker:OnOpacityMouseSliderBarChanged(wndHandler, wndControl, fValue, fOldValue)
...
local CRB_ObjectiveTrackerInst = CRB_ObjectiveTracker:new()
CRB_ObjectiveTrackerInst:Init()
