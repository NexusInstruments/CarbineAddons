-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_AdventureWhitevale
...
-----------------------------------------------------------------------------------------------
-- CRB_AdventureWhitevale Module Definition
-----------------------------------------------------------------------------------------------
local CRB_AdventureWhitevale = {} 
...
-- Initialization
-----------------------------------------------------------------------------------------------
function CRB_AdventureWhitevale:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self 
...
function CRB_AdventureWhitevale:Init()
    Apollo.RegisterAddon(self)
end

function CRB_AdventureWhitevale:OnSave(eType)
...
function CRB_AdventureWhitevale:OnRestore(eType, tSavedData)
...
-----------------------------------------------------------------------------------------------
-- CRB_AdventureWhitevale OnLoad
-----------------------------------------------------------------------------------------------\
function CRB_AdventureWhitevale:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("WhitevaleAdventure.xml")
	self.xmlDoc:RegisterCallback("OnDocumentReady", self) 
end

function CRB_AdventureWhitevale:OnDocumentReady()
...
function CRB_AdventureWhitevale:OnWindowManagementReady()
	Event_FireGenericEvent("WindowManagementAdd", {wnd = self.wnd, strName = Apollo.GetString("CRB_AdventureWhitevale"), nSaveVersion=3})
end

-----------------------------------------------------------------------------------------------
-- CRB_AdventureWhitevale Functions
-----------------------------------------------------------------------------------------------
-- Define general functions here

-- on SlashCommand "/whitevaleadv"
function CRB_AdventureWhitevale:OnWhitevaleAdventureOn()
	self.wnd:Show(true) -- show the window
	self.tAdventureInfo.bIsShown = true
end


function CRB_AdventureWhitevale:OnUpdateResource(iRep, iSons, iRollers, iGrinders)
...
function CRB_AdventureWhitevale:HideAll()
	for i = 1, 3 do
...
function CRB_AdventureWhitevale:OnShow(bShow)
	if bShow == true then
		self.wnd:Show(true)
...
function CRB_AdventureWhitevale:OnHide()
	self.wnd:Show(false)
...
function CRB_AdventureWhitevale:OnOK()
	self:OnHide()
end

-- when the Cancel button is clicked
function CRB_AdventureWhitevale:OnCancel()
	self:OnHide()
end


-----------------------------------------------------------------------------------------------
-- CRB_AdventureWhitevale Instance
-----------------------------------------------------------------------------------------------
local CRB_AdventureWhitevaleInst = CRB_AdventureWhitevale:new()
CRB_AdventureWhitevaleInst:Init()
