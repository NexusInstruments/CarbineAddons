...
etWeaselString(Apollo.GetString("MarketplaceListings_Hours"), nHours)
	elseif nMins > 0 then
...
function MarketplaceCREDD:OnCREDDOperationHistoryResults(tHistory)
	...
	for idx, tEntry in pairs(tHistory) do
		local wndEntry = Apollo.LoadForm(self.xmlDoc, "LogEntryBasicForm", self.tWindowMap["LogScroll"], 