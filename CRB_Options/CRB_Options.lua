-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_Options
...
function OptionsAddon:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_OptionsForms.xml")
...
function OptionsAddon:OnShowErrors(wndHandler, wndControl)
	...
	local wnd = Apollo.LoadForm("CRB_OptionsForms.xml", "AddonError", "OptionsDialogs", self)
...
function OptionsAddon:InvokeAddonLoadOnStartDlg(tAddon)
	...
	local wnd = Apollo.LoadForm("CRB_OptionsForms.xml", "AddonLoadOptions", "OptionsDialogs", self)
...
----------------------------------------------------------------------------------------
-- CRB_Options instance
---------------------------------------------------------------------------------------------------
local CRB_OptionsInst = OptionsAddon:new()
OptionsAddon:Init()
