...
function TutorialPrompts:OnLoad()
	self.xmlDoc = XmlDoc.CreateFromFile("CRB_TutorialPrompts.xml")
...
function TutorialPrompts:OnSlashShowTutorial(strCommand, strArg1) -- TODO TEMP: Testing method until a CRB_Tutorial Shower window gets put in, for nroth
...
---------------------------------------------------------------------------------------------------
-- CRB_Tutorial Panel Functions
---------------------------------------------------------------------------------------------------
function TutorialPrompts:DrawTutorialPage(nTutorialId, nPassedPage) --(wndArg, nCurrPage, tTutorial, nTutorialId)

	GameLib.StopTutorialSound() -- Stops any sounds currently being played by the CRB_Tutorial system
