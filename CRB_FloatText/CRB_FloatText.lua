...
function CRB_FloatText:Init()
	Apollo.RegisterAddon(self)
end

function CRB_FloatText:OnLoad()
...
function CRB_FloatText:OnOptionsUpdated()
...
function CRB_FloatText:GetDefaultTextOption()
	local tTextOption =
	{
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnSpellCastFailed( eMessageType, eCastResult, unitTarget, unitSource, strMessage )
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnSubZoneChanged(idZone, strZoneName)
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnRealmBroadcastTierMedium(strMessage)
	local tTextOption = self:GetDefaultTextOption()
	tTextOption.bUseScreenPos = true
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnActionBarNonSpellShortcutAddFailed()
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnGenericError(eError, strMessage)
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnPrereqFailed(strMessage)
	self:OnGenericError(nil, strMessage)
end

---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnGenericFloater(unitTarget, strMessage)
	-- modify the text to be shown
	local tTextOption = self:GetDefaultTextOption()
...
function CRB_FloatText:OnUnitEvaded(unitSource, unitTarget, eReason, strMessage)
	local tTextOption = self:GetDefaultTextOption()
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnAlertTitle(strMessage)
	local tTextOption = self:GetDefaultTextOption()
	tTextOption.fDuration = 2
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnQuestShareFloater(unitTarget, strMessage)
	local tTextOption = self:GetDefaultTextOption()
	tTextOption.fDuration = 2
	tTextOption.fFadeInDuration = 0.2
	tTextOption.fFadeOutDuration = 0.5
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnCountdownTick(strMessage)
	local tTextOption = self:GetDefaultTextOption()
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnDeath()
	local tTextOption = self:GetDefaultTextOption()
	tTextOption.fDuration = 2
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnCombatLogTransference(tEventArgs)
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnCombatMomentum( eMomentumType, nCount, strText )
...
function CRB_FloatText:OnExperienceGained(eReason, unitTarget, strText, fDelay, nAmount)
...
function CRB_FloatText:OnElderPointsGained(nAmount, nRested)
	if not Apollo.GetConsoleVariable("ui.showCombatFloater") or nAmount < 0 then
		return
	end
...
function CRB_FloatText:OnPathExperienceGained( nAmount, strText )
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnFactionFloater(unitTarget, strMessage, nAmount, strFactionName, idFaction) -- Reputation Floater
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnLootedMoney(monLooted) -- karCurrencyTypeToString filters to most alternate currencies but Money. Money displays in LootNotificationWindow.
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnTradeSkillFloater(unitTarget, strMessage)
	if not Apollo.GetConsoleVariable("ui.showCombatFloater") then
		return
	end
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnMiss( unitCaster, unitTarget, eMissType )
	if unitTarget == nil or not Apollo.GetConsoleVariable("ui.showCombatFloater") then
		return
	end
...
---------------------------------------------------------------------------------------------------
function CRB_FloatText:OnDamageOrHealing( unitCaster, unitTarget, eDamageType, nDamage, nShieldDamaged, nAbsorptionAmount, bCritical )
...
------------------------------------------------------------------
function CRB_FloatText:OnPlayerDamageOrHealing(unitPlayer, eDamageType, nDamage, nShieldDamaged, nAbsorptionAmount, bCritical)
...
------------------------------------------------------------------
function CRB_FloatText:GetDefaultCCStateTextOption()
	local tTextOption = self:GetDefaultTextOption()
	tTextOption.fScale = 1.0
	tTextOption.fDuration = 2
...
------------------------------------------------------------------
function CRB_FloatText:ShouldDisplayCCStateFloater( tEventArgs )
	if not Apollo.GetConsoleVariable("ui.showCombatFloater") then
		return false
	end
...
------------------------------------------------------------------
function CRB_FloatText:OnCombatLogCCState(tEventArgs)
...
------------------------------------------------------------------
function CRB_FloatText:OnCombatLogImmunity(tEventArgs)
...
------------------------------------------------------------------
function CRB_FloatText:OnCombatLogCCStatePlayer(tEventArgs)
	if not Apollo.GetConsoleVariable("ui.showCombatFloater") then
		return
	end
...
function CRB_FloatText:RequestShowTextFloater( eMessageType, unitTarget, strText, tTextOption, fDelay, tContent ) -- addtn'l parameters for XP/rep
	local tParams =
	{
...
------------------------------------------------------------------
function CRB_FloatText:OnDelayedFloatTextTimer()
...
local CRB_FloatTextInst = CRB_FloatText:new()
CRB_FloatTextInst:Init()
