...
function NCCB:OnLoad()
	...
	self.NCCB = Apollo.LoadForm("CRB_NonCombatCastBar.xml", "CRB_NonCombatCastBar", nil, self)
	self.NCCB:Show(false)
	
	self.Test = Apollo.LoadForm("CRB_NonCombatCastBar.xml", "NonCombatTestMenu", nil, self)
