-----------------------------------------------------------------------------------------------
-- Client Lua Script for CRB_SuggestedMenu
...
function CRB_SuggestedMenu:new(o)
    o = o or {}
    setmetatable(o, self)
    self.__index = self 
	return o
...
function CRB_SuggestedMenu:delete()
	Apollo.UnlinkAddon(self.luaOwner, self)
end

function CRB_SuggestedMenu:Init(luaOwner, xmlDoc)
...
function CRB_SuggestedMenu:CreateAndInitializeMap(wndTextBox)
	local wndMain = Apollo.LoadForm(self.xmlDoc, "CRB_SuggestedMenuForm", wndTextBox, self)
	self.tWindowMap =
	{
		["Main"] = wndMain,
...
-----------------------------------------------------------------------------------------------
-- CRB_SuggestedMenu Getting Data
-----------------------------------------------------------------------------------------------
--AccountFriends
function CRB_SuggestedMenu:OnFriendshipAccountFriendsRecieved(tFriendAccountList)
...
function CRB_SuggestedMenu:OnFriendshipAccountFriendRemoved(nFriendId)
...
--Friends
function CRB_SuggestedMenu:OnFriendshipLoaded()
	local strPlayerRealm = GameLib.GetRealmName()
...
function CRB_SuggestedMenu:OnFriendshipUpdate(nFriendId) -- this is for log in when needing to add non account friends, account friends are added OnFriendshipLoaded
...
function CRB_SuggestedMenu:OnFriendshipRemove(nFriendId)
...
--Group
function CRB_SuggestedMenu:OnGroupLeft(eReason)
...
function CRB_SuggestedMenu:OnGroupJoin(strName)
...
function CRB_SuggestedMenu:OnGroupAdd(strName)
	if not strName then 
		return 
	end
...
function CRB_SuggestedMenu:OnGroupRemove(strName, eReason)
	if not strName then 
		return 
	end
...
--Neighbor
function CRB_SuggestedMenu:OnHousingNeighborUpdate()--called on load and updating neighbor information 
...
function CRB_SuggestedMenu:OnUpdateRecent(tRecent)
	if not tRecent then
		return
	end
...
function CRB_SuggestedMenu:UpdateRelations(strAddName, tUpdateInfo)
...
function CRB_SuggestedMenu:HideSuggestedMenu()
...
function CRB_SuggestedMenu:OnSuggestedMenuNavigate()
...
function CRB_SuggestedMenu:OnInputChangedUpdateSuggested(wndTextBox, strText)
...
function CRB_SuggestedMenu:OnSuggestedMenuHide()
	self.tWindowMap["Main"]:Show(false)
	self.tResultBtns = {}
end

function CRB_SuggestedMenu:OnShowSuggestedMenu()
...
function CRB_SuggestedMenu:CreateSuggestedMenuEntry(tInfo)
...
function CRB_SuggestedMenu:OnSuggestedMenuEntry(wndHandler, wndControl)
...
-----------------------------------------------------------------------------------------------
-- CRB_SuggestedMenu HelperFunctions
-----------------------------------------------------------------------------------------------
function CRB_SuggestedMenu:HelperParseName(strText)
	if not strText then
		return
	end
...
function CRB_SuggestedMenu:HelperTabThroughSuggestedEntries()
...
function CRB_SuggestedMenu:HelperIsSuggestedMenuShown()
	return self.tWindowMap and self.tWindowMap["Main"] and self.tWindowMap["Main"]:IsShown()
end

function CRB_SuggestedMenu:SetFilters(tFilterIn)
...
function CRB_SuggestedMenu:HelperGetFilterTable(eRelationType)
...
function CRB_SuggestedMenu:HelperGetAllRelations()
	local tAll = {}
...
-----------------------------------------------------------------------------------------------
-- CRB_SuggestedMenu Instance
-----------------------------------------------------------------------------------------------
local CRB_SuggestedMenuInst = CRB_SuggestedMenu:new()
CRB_SuggestedMenuInst:Init()
